 ...
 */
class Version20180327121715_createDevAppliance1cView extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        // view.dev_appliance1c
        $this->addSql('CREATE OR REPLACE VIEW view.dev_appliance1c AS
            SELECT
              ac."__id" AS "appliance1C_id",
              a."__id" AS "appliance_id",
              p."serialNumber" AS "appliance_serialNumber",
            ...
            FROM "storage_1c"."appliances1C" AS ac
              LEFT JOIN equipment."appliances" AS a ON a.__id = ac.__voice_appliance_id
              LEFT JOIN equipment."platformItems" AS p ON p.__id = a.__platform_item_id
              JOIN "storage_1c"."inventoryItem1C" AS i ON i.__id = ac.__inventory_item_id
    ...
    public function down(Schema $schema)
    {
        ...
        // view.dev_appliance1c
        $this->addSql('DROP VIEW view.dev_appliance1c');
    }
}
