 ...
 */
class Version20180327125036_createDevModule1cView extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        // view.dev_module1c
        $this->addSql('CREATE OR REPLACE VIEW view.dev_module1c AS
            SELECT
              mc."__id" AS "module1C_id",
              mi."__id" AS "module_id",
              mi."serialNumber" AS "module_serialNumber",
            ...
            FROM "storage_1c"."modules1C" AS mc
              LEFT JOIN equipment."moduleItems" AS mi ON mi.__id = mc.__voice_module_id
              JOIN "storage_1c"."inventoryItem1C" AS i ON i.__id = mc.__inventory_item_id
    ...
    public function down(Schema $schema)
    {
        ...
        // view.dev_module1c
        $this->addSql('DROP VIEW view.dev_module1c');
    }
}
