...
/**
 * @ORM\Entity(repositoryClass="App\Repository\View\DevModule1CRepository")
 * @ORM\Table(name="dev_module1c", schema="view")
 */
class DevModule1C implements IInventoryItem1C
{
    /**
     * @ORM\Column(name="`module1C_id`", type="bigint")
     */
    private $module1C_id;

    /**
     * @ORM\Column(name="`module_id`", type="bigint")
     */
    private $module_id;

    /**
     * @ORM\Column(name="`module_serialNumber`", type="string")
     */
    private $module_serialNumber;
     ...
     * @return mixed
     */
    public function getModule1CId()
    {
        return $this->module1C_id;
    }
     ...
     * @return mixed
     */
    public function getModuleSerialNumber()
    {
        return $this->module_serialNumber;
    }
