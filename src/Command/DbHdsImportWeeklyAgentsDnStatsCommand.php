...
class DbHdsImportWeeklyAgentsDnStatsCommand extends Command
{
    protected static $defaultName = 'db:hds:import-weekly-agents-dn-stats';
    ...
    {
        $this->setDescription('Import HDS weekly call statistics by phones who used the agents license');
    }
